...
@section('content')
    ...
    <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        <!-- BEGIN: Side Menu -->
        <nav class="side-nav">
            <a href="" class="intro-x flex items-center pt-4 mt-3" style="margin-left:60px;">
                <img alt="Midone - HTML Admin Template" class="h-12" src="{{ asset('build/assets/images/logo1.png') }}">
            </a>
