    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            ...
            <div class="intro-y box p-10">
                <form action="{{ route('form-cate') }}" method="POST" class="card-body">
                    @csrf
                    ...
                    <div>
                        <label for="crud-form-1" class="form-label mt-5">Name</label>
                        <input id="crud-form-1" name="name" type="text" class="form-control w-full" placeholder="Category Name">
                    </div>
                    {{-- <div>
